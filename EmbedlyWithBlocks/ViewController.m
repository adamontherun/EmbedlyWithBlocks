...
- (IBAction)handleButtonTapped:(id)sender {
    ...
    //
    //    [[EmbedlyClient sharedClient] fetchExtractsForURLs:@[@"http://yahoo.com"]
    //                                            attributes:nil
    //                                            completion:^(NSArray *extracts, NSError *error) {
    //                                                NSLog(@"%@", extracts);
    //                                            }];
    
//    [[EmbedlyClient sharedClient] fetchEmbedsForURLs:@[@"http://vice.com", @"http://businessinsider.com"]
//                                                       attributes:attributes
//                                                       completion:^(NSArray *embeds, NSError *error) {
//        NSLog(@"%@", embeds);
//    }];
